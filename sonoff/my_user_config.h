...
#define WIFI_GATEWAY           "10.0.1.1"        // [IpAddress2] If not using DHCP set Gateway IP address
#define WIFI_SUBNETMASK        "255.255.255.0"   // [IpAddress3] If not using DHCP set Network mask
#define WIFI_DNS               "10.0.1.1"     // [IpAddress4] If not using DHCP set DNS IP address (might be equal to WIFI_GATEWAY)

#define STA_SSID1              "Kotona"                // [Ssid1] Wifi SSID
#define STA_PASS1              "minarakastansinua"                // [Password1] Wifi password
...
#define MQTT_HOST              "10.0.1.51"                // [MqttHost]
...
#define WEB_PASSWORD           "Stt1951_mrs"                // [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty string = Disable)
...
#define NTP_SERVER1            "0.nl.pool.ntp.org"       // [NtpServer1] Select first NTP server by name or IP address (129.250.35.250)
#define NTP_SERVER2            "1.nl.pool.ntp.org"    // [NtpServer2] Select second NTP server by name or IP address (5.39.184.5)
#define NTP_SERVER3            "2.nl.pool.ntp.org"  // [NtpServer3] Select third NTP server by name or IP address (93.94.224.67)
...
// -- Location ------------------------------------
#define LATITUDE               52.2587        // [Latitude] Your location to be used with sunrise and sunset
#define LONGITUDE              6.7580          // [Longitude] Your location to be used with sunrise and sunset
